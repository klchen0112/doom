...
(cond
  ((or IS-MAC IS-LINUX)
    (setq doom-font  (font-spec :family "M+CodeLat50 Nerd Font Mono" :size 16)
...
(if IS-MAC
    (progn
      (package! websocket-bridge :recipe (:host github :repo "ginqi7/websocket-bridge") :pin "535364f8fefd791b22525b7640d291e88c80179d")
     (package! org-reminders :recipe (:host github :repo "ginqi7/org-reminders") :pin "7d317b5591303265d86022de62498826285ba2c9"))
  )
#+end_src
...
(use-package! org-reminders
  ...
  :defer t
  :config
  (setq (concat org-directory "/Reminders.org")))
)
#+end_src
* org-roam
