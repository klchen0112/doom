...
(setq doom-themes-dark '(doom-dracula doom-vibrant doom-city-lights doom-moonlight doom-horizon
                         ...
                         doom-ephemeral chocolate doom-zenburn doom-peacock doom-1337 doom-rose-pine doom-rose-pine-moon ))
...
** Tree siter
#+begin_src emacs-lisp tangle: packages.el
;; (package! treesit-auto :recipe (:host github :repo "renzmann/treesit-auto" :files ("*.el" "dist")) :pin "016bd286a1ba4628f833a626f8b9d497882ecdf3")
...
*** virtual enviroment
#+begin_src emacs-lisp :tangle packages.el
(package! pet :recipe (:host github :repo "wyuenho/emacs-pet") :pin "5bc9cb882ad29f22ea049de2ab73c01b66c739d7")
#+end_src
